...
function getWxmlTag(doc, pos) {
    ...
    const attrName = isOnAttrValue ? base_1.getAttrName(attrFlagText.substring(0, offset)) : ''; // 当前输入对应的属性
    const isOnAttrName = !isOnTagName && !isOnAttrValue && !!posWord;
    return {
        name,
        attrs: base_1.getAttrs((attrstr || '').trim()),
        posWord,
        isOnTagName,
        isOnAttrName,
        isOnAttrValue,
...
//# sourceMappingURL=getWxmlTag.js.map